      ...
      <div className="container max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 mb-6">
            ...
            <span className="text-sm font-semibold text-blue-600 uppercase tracking-wide">What We Extract</span>
          </div>
          
          <h2 className="text-3xl lg:text-5xl font-bold mb-6">
            The <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Winning Moments</span> We Extract
          </h2>
          
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our AI automatically extracts the gold from your videos: hooks that stop scrolling, testimonials that build trust, and CTAs that convert. Use these winning moments across every marketing channel.
          </p>
        </div>
